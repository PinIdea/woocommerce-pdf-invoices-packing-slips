...
<table class="order-data">
	...
	<tr class="billing-email">
		<th><?php _e( 'Email:', 'wpo_wcpdf' ); ?></th>
		<td><?php $wpo_wcpdf->billing_email(); ?></td>
	</tr>        
        <?php } ?>
        <?php if ( isset($wpo_wcpdf->settings->template_settings['packing_slip_phone']) ) { ?>
 	<tr class="billing-phone">
		<th><?php _e( 'Phone:', 'wpo_wcpdf' ); ?></th>
		<td><?php $wpo_wcpdf->billing_phone(); ?></td>
	</tr>       
        <?php } ?>
	<tr class="shipping-country">
		<th><?php _e( 'Shipping Country Code:', 'wpo_wcpdf' ); ?></th>
		<td><?php echo $wpo_wcpdf->export->order->shipping_country; ?></td>
	</tr>
